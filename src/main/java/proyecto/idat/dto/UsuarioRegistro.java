...
public class UsuarioRegistro {
	...
	public UsuarioRegistro(String nombre, String apellidos, String telefono, String num_docu, String username,
			String password) {
		super();
		this.nombre = nombre;
		this.apellidos = apellidos;
	...
	public String toString() {
		return "UsuarioRegistro [nombre=" + nombre + ", apellidos=" + apellidos + ", telefono=" + telefono
