...
public class CategoriaService {
	...
	public void registrarCategoria(Categoria categoria) {
		...
		repository_C.registrarCategoria(IDCategoria, categoria.getCategoria(), categoria.getDescriph(),
				categoria.getPreciobase(), preciodesc, categoria.getEstado(), categoria.getFoto());
	...
	public void actualizarCategoria_foto(Categoria categoria) {
		...
		repository_C.actualizarCategoria(categoria.getIdcategoria(), categoria.getCategoria(), categoria.getDescriph(),
				categoria.getPreciobase(), categoria.getPreciodescuento(), categoria.getEstado(), categoria.getFoto());

	}

	public void actualizarCategoria(Categoria categoria) {

		repository_C.actualizarCategoria_sinfoto(categoria.getIdcategoria(), categoria.getCategoria(),
				categoria.getDescriph(), categoria.getPreciobase(), categoria.getPreciodescuento(),
				categoria.getEstado());
