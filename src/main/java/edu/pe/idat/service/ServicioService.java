...
public class ServicioService {
	...
	public void registrarServicio(Servicio servicio) {
		...
		repository.registrarServicio(IDServicio, servicio.getNombreservicio(), servicio.getDescripcion(),
				servicio.getEstado(), servicio.getImagen(), servicio.getPrecio());

	}

	public void actualizarServicio_foto(Servicio servicio) {

		repository.actualizarServicio(servicio.getIdservicios(), servicio.getNombreservicio(),
				servicio.getDescripcion(), servicio.getEstado(), servicio.getImagen(), servicio.getPrecio());

	}

	public void actualizarServicio_sinfoto(Servicio servicio) {

		repository.actualizarCategoria_sinfoto(servicio.getIdservicios(), servicio.getNombreservicio(),
				servicio.getDescripcion(), servicio.getEstado(), servicio.getPrecio());
