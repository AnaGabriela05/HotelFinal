...
public class TemporadaService {
	...
	public void registrarTemporada(Temporada tempo) {
		...
		repository_T.registrarTemporada(IDtempo, tempo.getFechafi(), tempo.getFechaini(), tempo.getTemporada(),
				tempo.getDescripcion(), tempo.getEstado(), tempo.getFoto());
	...
	public void actualizarTemporada_foto(Temporada tempo) {
		...
		repository_T.ActualizarTemporada(tempo.getIdtemporada(), tempo.getFechafi(), tempo.getFechaini(),
				tempo.getTemporada(), tempo.getDescripcion(), tempo.getEstado(), tempo.getFoto());

	}

	public void actualizarTemporada(Temporada tempo) {

		repository_T.ActualizarTemporada_sinfoto(tempo.getIdtemporada(), tempo.getFechafi(), tempo.getFechaini(),
				tempo.getTemporada(), tempo.getDescripcion(), tempo.getEstado());
