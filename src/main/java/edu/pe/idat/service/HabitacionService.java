...
public class HabitacionService {
	...
	public void registrarHabitacion(Habitacion habitacion) {
		...
		repository_HCRUD.registrarHabita(IDh, habitacion.getIdcategoria(), habitacion.getIdestado(),
				habitacion.getIdnivel());

	}

	public void actualizarhabita(Habitacion habitacion) {

		repository_HCRUD.ActualizarHabita(habitacion.getIdhabitacion(), habitacion.getIdcategoria(),
				habitacion.getIdestado(), habitacion.getIdnivel());
