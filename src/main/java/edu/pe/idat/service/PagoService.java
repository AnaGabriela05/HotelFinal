...
public class PagoService {
	...
	public void registrarPago(Double precio, String idreserva, String propietario, String numero_tarjeta, String cv,
			String vencimiento_mes, String vencimiento_año) {
		String IDn = generarID_Pago();
		repository.registrar_pago(IDn, precio, idreserva, propietario, numero_tarjeta, cv, vencimiento_mes,
				vencimiento_año);
