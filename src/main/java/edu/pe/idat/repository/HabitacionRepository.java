...
public interface HabitacionRepository extends JpaRepository<Habitacion, String> {
	...
	void registrarHabita(@Param("idhabitacions") String idhabitacion, @Param("idcategorias") String idcategoria,
			@Param("idestados") String idestado, @Param("idnivels") String idnivel
	...
	void ActualizarHabita(@Param("idhabitacions") String idhabitacion, @Param("idcategorias") String idcategoria,
			@Param("idestados") String idestado, @Param("idnivels") String idnivel);

	@Transactional
	@Modifying
	@Query(value = "{call Cambiar_Estado_Habitacion_x_Reserva(:habi, :estado)}", nativeQuery = true)
	void actualizar_e_h_x_r(@Param("habi") String habis, @Param("estado") String estados
