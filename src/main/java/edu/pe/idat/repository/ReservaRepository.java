...
public interface ReservaRepository extends JpaRepository<Reservas, String> {
	...
	void registrarReserva(@Param("idrese") String idreserva, @Param("fechaent") LocalDate fechaentrada,
			@Param("fechasal") LocalDate fechasalida, @Param("nomuser") String nombreuser,
			@Param("apeuser") String apellidouser, @Param("correouser") String correouser,
			@Param("fonouser") String telefonouser, @Param("idhabi") String idhabitacion,
			@Param("idusu") Long idusuario, @Param("statusrese") String estado_reserva,
	...
	void actualizarReserva(@Param("idrese") String idreserva, @Param("fechaent") LocalDate fechaentrada,
			@Param("fechasal") LocalDate fechasalida, @Param("nomuser") String nombreuser,
			@Param("apeuser") String apellidouser, @Param("correouser") String correouser,
			@Param("fonouser") String telefonouser, @Param("idhabi") String idhabitacion,
			@Param("idusu") Long idusuario, @Param("statusrese") String estado_reserva,
