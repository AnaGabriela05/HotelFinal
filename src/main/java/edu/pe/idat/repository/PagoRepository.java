...
public interface PagoRepository extends JpaRepository<Pago, String> {
	...
	void registrar_pago(@Param("idpagos") String idpago, @Param("precios") Double precio,
			@Param("idserv") String idserv, @Param("propietarios") String propietar,
			@Param("numero_tarjetas") String num_tar, @Param("cvvs") String cv, @Param("vencimiento_mess") String v_m,
	...
	void actualizar_pago(@Param("idpagos") String idpago, @Param("precios") Double precio
