...
public interface CategoriaRepository extends JpaRepository<Categoria, String> {
	...
	void registrarCategoria(@Param("idcategorias") String idcategoria, @Param("categorias") String categoria,
			@Param("descriphs") String descriph, @Param("preciobases") Double preciobase,
			@Param("preciodescuentos") Double preciodescuento, @Param("estados") String estados,
	...
	void actualizarCategoria(@Param("idcategorias") String idcategoria, @Param("categorias") String categoria,
			@Param("descriphs") String descriph, @Param("preciobases") Double preciobase,
			@Param("preciodescuentos") Double preciodescuento, @Param("estados") String estados,
			@Param("fotos") String fotos
	...
	void actualizarCategoria_sinfoto(@Param("idcategorias") String idcategoria, @Param("categorias") String categoria,
			@Param("descriphs") String descriph, @Param("preciobases") Double preciobase,
			@Param("preciodescuentos") Double preciodescuento, @Param("estados") String estados
