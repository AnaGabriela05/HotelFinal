...
public interface NivelRepository extends JpaRepository<Nivel, String> {
	...
	void registrarnivel(@Param("idnivels") String idnivel, @Param("numpisos") String numpiso,
			@Param("capacidads") int capacidad, @Param("estados") String estado
	...
	void actualizar_nivel(@Param("idnivels") String idnivel, @Param("numpisos") String numpiso,
			@Param("capacidads") int capacidad, @Param("estados") String estado
