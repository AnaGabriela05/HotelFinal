...
public interface ServicioRepository extends JpaRepository<Servicio, String> {
	...
	void registrarServicio(@Param("idservicioss") String idservicio, @Param("nombreservicios") String nombreservicio,
			@Param("descripcions") String descrip, @Param("estados") String estado, @Param("imagens") String imagen,
	...
	void actualizarServicio(@Param("idservicioss") String idservicio, @Param("nombreservicios") String nombreservicio,
			@Param("descripcions") String descrip, @Param("estados") String estado, @Param("imagens") String imagen,
	...
	void actualizarCategoria_sinfoto(@Param("idservicioss") String idservicio,
			@Param("nombreservicios") String nombreservicio, @Param("descripcions") String descrip,
