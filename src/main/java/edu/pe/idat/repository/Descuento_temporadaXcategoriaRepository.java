...
public interface Descuento_temporadaXcategoriaRepository extends JpaRepository<Descuento_temporadaXcategoria, String> {
	...
	void registrarDescuento(@Param("idprecios") String idprecios, @Param("descuentos") int descuentos,
			@Param("idtemporadas") String idtemporadas, @Param("idcategorias") String idcategorias
	...
	@Transactional
	@Modifying
	@Query(value = "{call actualizar_descuento(:id, :descuentos)}", nativeQuery = true)
