...
public interface TemporadaRepository extends JpaRepository<Temporada, String> {
	...
	void registrarTemporada(@Param("idtemporadas") String idtemporada, @Param("fechafis") LocalDate fechafi,
			@Param("fechainis") LocalDate fechaini, @Param("temporadas") String temporada,
			@Param("descripcions") String descripcion, @Param("estados") String estado, @Param("fotos") String foto
	...
	void ActualizarTemporada(@Param("idtemporadas") String idtemporada, @Param("fechafis") LocalDate fechafi,
			@Param("fechainis") LocalDate fechaini, @Param("temporadas") String temporada,
			@Param("descripcions") String descripcion, @Param("estados") String estado, @Param("fotos") String foto);
	...
	void ActualizarTemporada_sinfoto(@Param("idtemporadas") String idtemporada, @Param("fechafis") LocalDate fechafi,
			@Param("fechainis") LocalDate fechaini, @Param("temporadas") String temporada,
			@Param("descripcions") String descripcion, @Param("estados") String estado
