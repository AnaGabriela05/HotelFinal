...
public interface Reserva_Servicio_Repository extends JpaRepository<Reserva_Servicio, String> {
	...
	void registrar_reserva_servicio(
			...
			@Param("idrese") String idreserva, @Param("idservi") String idservicios);
	...
	void actualizar_reserva_servicio(@Param("idreseservi") int idr_x_s, @Param("idrese") String idreserva,
